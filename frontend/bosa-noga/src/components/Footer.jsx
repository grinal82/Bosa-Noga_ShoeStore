      ...
      <div className="col">
        <section>
          ...
          <ul className="nav flex-column">
            <li className="nav-item"><NavLink href="/about.html" className="nav-link">О магазине</NavLink></li>
            <li className="nav-item"><NavLink href="/catalog.html" className="nav-link">Каталог</NavLink></li>
            <li className="nav-item"><NavLink href="/contacts.html" className="nav-link">Контакты</NavLink></li>
          </ul>
        </section>
      </div>
      <div className="col">
